      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        {liveCount > 0 && (
          <div className="flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 px-4 py-2 rounded-xl text-sm font-semibold">
            <span className="dot-live" style={{ background: '#f97316', boxShadow: '0 0 0 0 rgb(249 115 22 / .4)' }} />
        ...
        <div className="card p-5 xl:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={hourlyForChart} margin={{ left: -20 }}>
              ...
              <Area type="monotone" dataKey="revenue" name="Revenue" stroke="#f97316" fill="url(#revGrad)" strokeWidth={2.5} dot={false} activeDot={{ r: 5, fill: '#f97316', strokeWidth: 2, stroke: '#fff' }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
