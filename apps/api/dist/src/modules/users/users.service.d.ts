...
export declare class UsersService {
    ...
    getOrderHistory(userId: string, page?: number, limit?: number, lang?: string | null): Promise<{
        orders: ({
            outlet: {
                name: string;
                id: string;
    ...
    getCustomerStats(userId: string, from?: Date, to?: Date, lang?: string | null): Promise<{
        range: {
            from: string;
            to: string;
        };
    ...
    getCustomerPromotions(userId: string): Promise<{
        outlets: {
            outlet: {
                id: string;
                name: string;
    ...
    setPreferredLanguage(userId: string, code: string): Promise<{
        id: string;
